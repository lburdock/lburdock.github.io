...
| -------------- | :----------------------------------------------------------: | :----------------------------------------------------------------: | :----------------------------------------------------------------: |
| **getBy**      |      <span className="badge badge--danger">Error</span>      |       <span className="badge badge--primary">Element</span>        |         <span className="badge badge--danger">Error</span>         |
...
| **queryBy**    |      <span className="badge badge--primary">null</span>      |       <span className="badge badge--primary">Element</span>        |         <span className="badge badge--danger">Error</span>         |
...
| **findBy**     | <span className="badge badge--danger">Promise<Error\></span> |  <span className="badge badge--primary">Promise<Element\></span>   |    <span className="badge badge--danger">Promise<Error\></span>    |
